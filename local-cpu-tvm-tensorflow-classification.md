...
Inference time
```
* *First inference duration* (usually including allocation time): **0.07690079299999297**,
* *Mean*: **0.07411475465306198 s**,
* *Standard deviation*: **0.0007192627803398955 s**,
* *Median*: **0.07386883000000921 s**.
...
* *Mean*: **50.62832491582491 %**,
* *Standard deviation*: **2.8756869500753637 %**,
* *Median*: **50.0 %**.
...
* *Mean*: **9.170791245791246 %**,
* *Standard deviation*: **0.07474117082951337 %**,
* *Median*: **9.2 %**.
